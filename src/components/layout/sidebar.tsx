...
const Sidebar = ({}: Props) => {
  return (
    <aside className="col-span-2 h-screen flex flex-col border-r border-gray-200 p-4">
      ...
      <div className="flex-1 flex flex-col mt-10 gap-4">
        ...
        <div className="flex gap-3">
          ...
          <span className="flex items-center justify-center bg-gray-200 text-gray-50 h-6 w-9 rounded-full ml-auto ">
            10
          </span>
        </div>
        <div className="flex gap-3">
